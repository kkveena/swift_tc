...
from models.swft_tc.src.io import (
    ERROR_COLUMNS,
    ProcessingError,
    read_output_csv,
    write_errors_csv,
...
from models.swft_tc.src.settings import OUTPUT_FIELD_KEYS, load_config
...
class TestLegacyNamingStyle:
    def test_legacy_style_emits_only_legacy_names(
        self, model_root, tmp_path, group_config, reference_provider, mock_client
    ):
        config = load_config(
