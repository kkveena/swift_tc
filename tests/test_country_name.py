...
from swift_address.scoring import error_result, null_result, verify_extraction
...
class TestVerifiedExtractionCountryName:
    ...
    def test_separator_inside_a_name_is_folded(self, iso_provider):
        ...
        from swift_address.reference_data import CountryRecord, Iso3166Provider
...
class TestCountryNameInOutput:
    ...
    def test_column_is_present_and_populated(self, config, frame, reference_provider):
        from swift_address.gemini_client import ScriptedExtractionClient
