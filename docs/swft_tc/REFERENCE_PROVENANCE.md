...
`models/swft_tc/data/reference/town_country_reference.csv`
...
```bash
python scripts/swft_tc/build_geonames_town_country_reference.py   --output models/swft_tc/data/reference/town_country_reference.csv   --include-ascii-alias
```
